...
@pipeline(lambda_pipeline=True, celery_pipeline=True, celery_include_files=['components/component_1.py', 'components/component_2.py'], celery_concurrency_threads=8)
